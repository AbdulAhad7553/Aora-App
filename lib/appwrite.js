...
export const appwriteConfig = {
    ...
    projectId: "66966d5a0022258a7aa2",
    databaseId: "66966e7a002636ed804b",
    userCollectionId: "66966e98001e8a3cda14",
    videoCollectionId: "66966ecb0016c8d3d633",
    storageId: "66966fde0008959333e6"
}
...
export const createUser = async (email, password, username) => {
    ...
    try {
        ...
        const newUser = await databases.createDocument(databaseId, userCollectionId, ID.unique(), {accountId: newAccount.$id, email, username, avatar: avatarUrl} );
        return newUser;
...
export const signIn = async(email, password)=> {
    try {
        ...
        //     for (let session of sessionsList.sessions) {
...
export const getFilePreview = async (fileId, type) => {
    ...
    try {
        ...
        if (!fileUrl) throw Error('File URL not generated');
